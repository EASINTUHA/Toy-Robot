...
const AllToys = () => {
    ...
    useEffect(() => {
        fetch("https://assignment-11-server-nine-blue.vercel.app/alltoys", {
          params: { limit: 20 },
        })
          .then((res) => res.json())
    ...
    const handleSearch = () => {
        fetch(
          `https://assignment-11-server-nine-blue.vercel.app/toysearch/${searchQuery}`
        )
          .then((res) => res.json())
          .then((data) => setToys(data));
    };
    ...
    const handleViewDetails = (_id) => {
      ...
      if (isLoggedIn) {
        ...
        navigate(
          `https://assignment-11-server-nine-blue.vercel.app/alltoys/${_id}`
        );
      } else {
